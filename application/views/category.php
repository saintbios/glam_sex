					...
					<div class="thumbnailContainer">
						...
						<div class="thumbnailDescriptionContainer">
							...
							<div style="float:left;font-size:10px;">
								<img src="<?php echo(base_url() . 'assets/images/eye_open.png');?>" class="thumbnailViewIcon" /> <?php echo($views);?>
							</div>
							<div style="float:right;font-size:10px;">
								<img src="<?php echo(base_url() . 'assets/images/thumbs_up.png');?>" class="thumbnailThumbsIcon" /> <?php echo($video->rating);?>% (<?php echo($video->ratings);?> votes)
							</div>
						</div>	
					</div>
				<?php }?>
